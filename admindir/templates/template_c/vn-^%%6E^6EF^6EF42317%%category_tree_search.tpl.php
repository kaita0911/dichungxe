<?php /* Smarty version 2.6.30, created on 2026-03-04 18:26:34
...
<option value="<?php echo $this->_tpl_vars['node']['id']; ?>
" <?php if (is_array($this->_tpl_vars['selected']) && in_array ( $this->_tpl_vars['node']['id'] , $this->_tpl_vars['selected'] )): ?>selected<?php endif; ?>>
...
$this->_smarty_include(array('smarty_include_tpl_file' => "articlelist/category_tree_search.tpl", 'smarty_include_vars' => array('node' => $this->_tpl_vars['child'],'selected' => $this->_tpl_vars['selected'])));
