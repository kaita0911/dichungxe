 ...
 ?>
    ...
    <div class="right_content conten">
      <form name="allsubmit" id="frmEdit"
        action="index.php?do=footer&act=<?php if ($_REQUEST['act'] == 'add'): ?>addsm<?php else: ?>editsm<?php endif; ?>&id=<?php echo $_REQUEST['id']; ?>
"
        method="post" enctype="multipart/form-data">
        <input type="hidden" name="id" value="<?php echo $this->_tpl_vars['footer']['id']; ?>
" />
        <div class="divright">
          <div class="acti2">
...
?>
              ...
              <?php $_from = $this->_tpl_vars['footerDetail']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
">
                <div class="item">
                  ...
                  <!-- <div class="info-title">
                    <input type="text" name="name" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['edit_name']['name'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html', 'UTF-8') : smarty_modifier_escape($_tmp, 'html', 'UTF-8')); ?>
" class="InputText" id="title" />
                  </div> -->
                  <div class="info-title">
...
" <?php if ($this->_tpl_vars['lang']['code'] == 'vi'): ?>required<?php endif; ?> />
                ...
                <div class="item">
                  ...
                  <div class="info-title">
                    <input type="text" name="languages[<?php echo $this->_tpl_vars['lang']['id']; ?>
][address]" value="<?php echo $this->_tpl_vars['detail']['address']; ?>
" class="InputText" />
                  </div>
                </div>
                <div class="item">
...
" name="languages[<?php echo $this->_tpl_vars['lang']['id']; ?>
              ...
              <?php endforeach; endif; unset($_from); ?>
                ...
                <div class="info-title">
                  <textarea class="InputTextarea" name="map"><?php echo $this->_tpl_vars['footer']['map']; ?>
</textarea>
                </div>
              </div>
            </div>             <div class="right100">
              <div class="item">
                <div class="title">Hotline</div>
                <div class="info-title">
                  <input type="text" name="hotline" value="<?php echo $this->_tpl_vars['footer']['hotline']; ?>
" class="InputText" />
                </div>
              </div>
              <div class="item">
                ...
                <div class="info-title">
                  <input type="text" name="email" value="<?php echo $this->_tpl_vars['footer']['email']; ?>
" class="InputText" />
                </div>
              </div>
            </div>           </div>
