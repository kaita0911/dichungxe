   ...
   <div class="container">
      <div class="p-commit">
         ...
         <ul class="p-commit__nav">
            ...
            <li class="{if $smarty.foreach.tab.first}active{/if}"
               data-tab="commit-tab-{$smarty.foreach.tab.index}">
               {$item.name_detail}
            </li>
            {/foreach}
         </ul>
      ...
      <div class="categories-tab">
         ...
         <div class="categories-tab__content">
            ...
            <div class="cate-tab-pane"
               id="cate-tab-{$smarty.foreach.tab.index + 1}">
         ...
         <div class="js-feedback">
            ...
            <div class="feedback-item">
               <div class="feedback-item__img">
                  <img src="{$item.img_thumb_vn}?width=800&height=800&mode=cover" alt="{$item.name_detail}" class="img-cover" loading="lazy">
               </div>
   ...
   <div class="p-news">
      <div class="container">
         ...
         <div class="p-news-wrap js-news">
            ...
            <div class="news-item">
               <a class="news-item__img hover-img" href="{$path_url}/{$lang_prefix}{$item.unique_key}.html" title="{$item.name_detail}">
                  <img src="{$item.img_thumb_vn}?width=800&height=600&mode=cover" alt="{$item.name_detail}" class="img-cover" loading="lazy">
               </a>
               <h3><a class="news-item__ttl hover" href="{$path_url}/{$lang_prefix}{$item.unique_key}.html" title="{$item.name_detail}">{$item.name_detail}</a></h3>
               <div class="news-item__short">{$item.short}</div>
               <a href="{$path_url}/{$lang_prefix}{$item.unique_key}.html" class="viewmore" title="xem thêm">Xem thêm</a>
            </div>
            {/foreach}
         </div>
      </div>
