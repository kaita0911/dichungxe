<?php /* Smarty version 2.6.30, created on 2026-02-01 06:24:27
   ...
   <div class="container">
      <div class="p-commit">
         ...
         <ul class="p-commit__nav">
            <?php $_from = $this->_tpl_vars['commit'];
            if (!is_array($_from) && !is_object($_from)) {
               settype($_from, 'array');
            }
            $this->_foreach['tab'] = array('total' => count($_from), 'iteration' => 0);
   ...
   <div class="container">
      ...
      <div class="categories-tab">
         ...
         <ul class="categories-tab__nav">
            ...
            <?php $_from = $this->_tpl_vars['home_categories'];
            if (!is_array($_from) && !is_object($_from)) {
               settype($_from, 'array');
            }
            $this->_foreach['tab'] = array('total' => count($_from), 'iteration' => 0);
               ...
               <section class="home-category">
                  <div class="p-products">
                     ...
                     if (count($_from)):
                        foreach ($_from as $this->_tpl_vars['cat']):
                     ?>
                           <?php $_from = $this->_tpl_vars['cat']['products'];
                           if (!is_array($_from) && !is_object($_from)) {
                              settype($_from, 'array');
                           }
                           if (count($_from)):
   ...
   <div class="p-feedback">
      <div class="container">
         ...
         <div class="js-feedback">
            <?php $_from = $this->_tpl_vars['feedback'];
            if (!is_array($_from) && !is_object($_from)) {
               settype($_from, 'array');
            }
            if (count($_from)):
   ...
   <div class="p-news">
      <div class="container">
         ...
         <div class="p-news-wrap js-news">
            <?php $_from = $this->_tpl_vars['news_home'];
            if (!is_array($_from) && !is_object($_from)) {
               settype($_from, 'array');
            }
            if (count($_from)):
